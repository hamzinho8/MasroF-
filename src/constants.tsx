...
export const INITIAL_PREDEFINED_ITEMS: PredefinedItem[] = [
  ...
  { id: '4', name: 'Bambers', price: 4.5, category: 'Sanitaire', iconName: 'Baby', frequent: true },
  ...
  { id: 'champo', name: 'Champo', price: 10, category: 'Sanitaire', iconName: 'Wind', frequent: true },

  // Devoir
  { id: 'fam', name: 'Aide Famille', price: 500, category: 'Devoir', iconName: 'Heart', frequent: true },
  { id: 'parents', name: 'Parents', price: 0, category: 'Devoir', iconName: 'Users', frequent: true },
  { id: 'enfants', name: 'Enfants', price: 0, category: 'Devoir', iconName: 'Baby', frequent: true },
  { id: 'femme', name: 'Femme', price: 0, category: 'Devoir', iconName: 'User', frequent: true },
  { id: 'inconnu', name: 'Inconnu', price: 0, category: 'Devoir', iconName: 'HelpCircle', frequent: true },
