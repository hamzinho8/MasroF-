...
- 'category': The category, strictly ONE of ['Gourmandises', 'Protéines', 'Essentiel', 'Plantes', 'Logement', 'Transport', 'Sanitaire', 'Shopping', 'Loisirs', 'Devoir', 'Autres']. Attention: L'eau et les boissons doivent TOUJOURS être classés dans 'Gourmandises' ou 'Essentiel'.
