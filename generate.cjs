...
const products = [
  ...
  { name: "Danone", name_ar: "دانون", brand: "Danone", category: "Nourriture", icon: "Container", keywords: ["danone", "yaourt", "danon", "ياغورت"] },
  { name: "Raibi", name_ar: "رايبي", brand: "", category: "Nourriture", icon: "Container", keywords: ["raibi", "jamila", "رايبي", "raybi"] },
  ...
  // Eaux & Boissons
  { name: "Eau", name_ar: "ماء", brand: "", category: "Nourriture", icon: "Milk", keywords: ["eau", "ma", "luma", "ماء", "bouteille"] },
  { name: "Sidi Ali", name_ar: "سيدي علي", brand: "Sidi Ali", category: "Nourriture", icon: "Milk", keywords: ["sidi ali", "sidiali"] },
  { name: "Ain Atlas", name_ar: "عين أطلس", brand: "Ain Atlas", category: "Nourriture", icon: "Milk", keywords: ["ain atlas"] },
  { name: "Ain Saiss", name_ar: "عين سايس", brand: "Ain Saiss", category: "Nourriture", icon: "Milk", keywords: ["saiss", "ain saiss"] },
  { name: "Ciel", name_ar: "سييل", brand: "Ciel", category: "Nourriture", icon: "Milk", keywords: ["ciel"] },
  { name: "Oulmes", name_ar: "والماس", brand: "Oulmes", category: "Nourriture", icon: "Milk", keywords: ["oulmes", "walmas", "eau gazeuse"] },
  ...
  { name: "Liquide Vaisselle", name_ar: "سائل الأواني", brand: "", category: "Sanitaire", icon: "SprayCan", keywords: ["liquide vaisselle", "vaisselle", "sabon lweni", "sabon m3an", "أواني"] },
  { name: "Fairy", name_ar: "فيري", brand: "Fairy", category: "Sanitaire", icon: "SprayCan", keywords: ["fairy"] },
  { name: "Oni", name_ar: "أوني", brand: "Oni", category: "Sanitaire", icon: "SprayCan", keywords: ["oni", "ony"] },
  { name: "Magix", name_ar: "ماجيكس", brand: "Magix", category: "Sanitaire", icon: "SprayCan", keywords: ["magix", "majix"] },
